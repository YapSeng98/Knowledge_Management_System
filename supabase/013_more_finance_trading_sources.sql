...
insert into resources (id, track_id, level, position, title, url, type, roadmap_label) values
  ...
  ('s13-0-3', 13, 0, 3, 'University of Michigan — Finance for Everyone: Smart Tools for Decision-Making, free audit on edX', 'https://www.edx.org/learn/financial-literacy/the-university-of-michigan-finance-for-everyone-smart-tools-for-decision-making', 'course', 'edX/Michigan — Finance for Everyone, free audit'),
